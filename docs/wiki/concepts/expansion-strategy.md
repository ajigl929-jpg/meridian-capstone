...
Sources: [raw/client-brief.md](../../../raw/client-brief.md), [raw/icsc-grocery-sector-trends.md](../../../raw/icsc-grocery-sector-trends.md)
...
Sector-wide, specialty grocers are gaining share against traditional
supermarkets and grocery-anchored real estate is seeing strong
investor appetite — see
[Grocery Industry Trends](grocery-industry-trends.md). That context
supports the case for continued expansion but doesn't resolve
Meridian-specific site economics.
